# script for training a deterministic transformation of data to a simpler distirbution
# uses layers which are "batch NADE" type generative processes
...
batch_size = 100
model_save = 'nice_warped_mnist.pkl'
save_freq = 10
n_epochs = 1000
...
#        import pdb; pdb.set_trace()
        self.log_jacobian = Hidden1.log_jacobian + Hidden2.log_jacobian \
            + Hidden3.log_jacobian + Final.log_jacobian
...
class ScaleLayer(object):
    def __init__(self, rng, input, n_in, n_batch, log_scale=None):
        ...
        if log_scale is None:
            log_scale_values = numpy.zeros([1, n_in], dtype=theano.config.floatX)
