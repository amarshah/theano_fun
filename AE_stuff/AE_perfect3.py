...
class FullAE(object):
    def __init__(self, rng, input, n_in, n_batch, d_bucket, activation, activation_deriv):
        ...
        self.log_jacobian = self.Hidden1.log_jacobian + self.Hidden2.log_jacobian + self.Final.log_jacobian 

        self.params = self.Hidden1.params + self.Hidden2.params + self.Final.params
...
def train_AE(learning_rate=0.005, n_epochs=1000, batch_size=100, d_bucket=20,
             activation=nonlinearity, activation_deriv=nonlinearity_deriv,
             model_save='AE3.pkl', save_freq=10):  
