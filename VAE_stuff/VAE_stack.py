...
h1 = encoder1 + epsilon1 * srng.uniform(size=encoder1.shape,
...
h2 = encoder2 + epsilon2 * srng.uniform(size=encoder2.shape,
...
decoder_params = decoder_network1.apply(h2)
decoder_mu = decoder_params[:, :n_latent1]
decoder_lognu = decoder_params[:, n_latent1:]
