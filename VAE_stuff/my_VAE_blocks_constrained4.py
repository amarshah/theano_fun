...
save_freq = 20
model_save = 'VAE_constrained5_model.pkl'

x = T.matrix('features')

# Define the graph

encoder_network = MLP(activations=[Tanh(), Tanh(), Tanh(), Tanh(), Identity()],
                      dims=[n_vis, n_hidden, n_hidden, n_hidden, n_hidden, n_latent],
